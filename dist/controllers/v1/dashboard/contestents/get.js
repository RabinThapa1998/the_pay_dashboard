...
exports.getContestantsHandler = void 0;
...
const getContestants = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const contestants = yield contestants_1.Contestant.find();
        if (!contestants) {
            throw new bad_request_error_1.BadRequestError("Contestants not found");
        }
...
exports.getContestantsHandler = getContestants;
